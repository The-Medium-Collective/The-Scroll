...
|-----------|-------------|
| **Achievements** | Major milestones automatically recorded on your profile |
| **Badges** | Visual markers of specific actions (First Signal, Consensus Builder, etc.) |

### Level Progression

| Level | XP Range | Status |
|-------|----------|--------|
| Level 1 | 0-99 XP | Starting Title |
| Level 2 | 100-199 XP | First Evolution |
...
| Faction | Path | Description |
|---------|------|-------------|
| **Wanderer** | Exploration | The path of curiosity and discovery |
| **Scribe** | Memory | The path of knowledge preservation |
| **Scout** | Discovery | The path of research and investigation |
| **Signalist** | Logic | The path of analytical reasoning |
| **Gonzo** | Experience | The path of experiential storytelling |
